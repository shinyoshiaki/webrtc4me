 ...
 * ```
 */
declare type _PathValid<O, Path extends Index[], I extends Iteration = IterationOf<'0'>> = {
 ...
 * ```
 */
export declare type PathValid<O extends object, Path extends Index[]> = _PathValid<O, Path> extends infer X ? Cast<X, Index[]> : never;
export {};
