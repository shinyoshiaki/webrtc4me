...
var Decoder_Decoder = /** @class */ (function () {
    function Decoder(extensionCodec, maxStrLength, maxBinLength, maxArrayLength, maxMapLength, maxExtLength) {
        if (extensionCodec === void 0) { extensionCodec = ExtensionCodec_ExtensionCodec.defaultCodec; }
    ...
    Decoder.prototype.decodeStream = function (stream) {
        return __asyncGenerator(this, arguments, function decodeStream_1() {
            var stream_2, stream_2_1, buffer, result, e_2, e_3_1;
            var e_3, _a;
            return __generator(this, function (_b) {
                switch (_b.label) {
                    ...
                    case 2:
                        if (!(stream_2_1 = _b.sent(), !stream_2_1.done)) return [3 /*break*/, 10];
                    ...
                    case 12:
                        ...
                        if (!(stream_2_1 && !stream_2_1.done && (_a = stream_2.return))) return [3 /*break*/, 14];
    ...
    Decoder.prototype.decodeArrayStream = function (stream) {
        return __asyncGenerator(this, arguments, function decodeArrayStream_1() {
            var headerParsed, decoded, itemsLeft, stream_3, stream_3_1, buffer, result, e_4, e_5_1;
            var e_5, _a;
            return __generator(this, function (_b) {
                switch (_b.label) {
                    case 0:
                    ...
                    case 3:
                        if (!(stream_3_1 = _b.sent(), !stream_3_1.done)) return [3 /*break*/, 12];
                    ...
                    case 9:
                        e_4 = _b.sent();
                        if (!(e_4 instanceof DataViewIndexOutOfBoundsError)) {
                            throw e_4; // rethrow
                        }
                        return [3 /*break*/, 10];
                    case 10:
                    ...
                    case 14:
                        ...
                        if (!(stream_3_1 && !stream_3_1.done && (_a = stream_3.return))) return [3 /*break*/, 16];
                        return [4 /*yield*/, __await(_a.call(stream_3))];
                    case 15:
                        _b.sent();
                        _b.label = 16;
...
function decodeAsync(streamLike, options) {
    ...
    return decodeAsync_awaiter(this, void 0, void 0, function () {
        ...
        return decodeAsync_generator(this, function (_a) {
            ...
            return [2 /*return*/, decoder.decodeOneAsync(stream)];
        });
    });
}
