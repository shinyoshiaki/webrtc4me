...
class Encoder {
    constructor(extensionCodec = ExtensionCodec_1.ExtensionCodec.defaultCodec, maxDepth = exports.DEFAULT_MAX_DEPTH, initialBufferSize = exports.DEFAULT_INITIAL_BUFFER_SIZE, sortKeys = false, forceFloat32 = false) {
    ...
    encodeString(object) {
        ...
        if (utf8_1.TEXT_ENCODING_AVAILABLE && strLength > utf8_1.TEXT_ENCODER_THRESHOLD) {
        ...
        else if (wasmFunctions_1.WASM_AVAILABLE && strLength > wasmFunctions_1.WASM_STR_THRESHOLD) {
            ...
            const ouputLength = wasmFunctions_1.utf8EncodeWasm(object, this.bytes, this.pos);
