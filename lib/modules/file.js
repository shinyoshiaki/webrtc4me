...
var Downloading = function (now, size) {
    return {
        type: "downloading",
        payload: { now: now, size: size }
    };
};
var Downloaded = function (chunks, name) {
    return {
        type: "downloaded",
...
var FileShare = /** @class */ (function () {
        ...
        peer.onData.subscribe(function (raw) {
            ...
            if (label === _this.label) {
                try {
                    ...
                    _this.event.execute(Downloading(_this.chunks.length, _this.size));
                }
            }
        });
    }
    ...
    FileShare.prototype.send = function (blob) {
        ...
        getSliceArrayBuffer(blob).subscribe(function (chunk) { return _this.sendChunk(chunk); }, function () { }, function () { return _this.sendEnd(); });
    };
    return FileShare;
}());
