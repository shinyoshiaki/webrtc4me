...
var WebRTC = /** @class */ (function () {
            ...
            return tslib_1.__generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        ...
                        return [4 /*yield*/, this.rtc.createOffer().catch(console.log)];
                    case 1:
                        sdp = _a.sent();
                        if (!sdp)
                            return [2 /*return*/];
        ...
        return tslib_1.__awaiter(this, void 0, void 0, function () {
            ...
            return tslib_1.__generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 1:
                        _a.sent();
                        return [4 /*yield*/, this.rtc.createAnswer().catch(console.log)];
                    case 2:
                        answer = _a.sent();
                        if (!answer) {
                        ...
                        return [4 /*yield*/, this.rtc.setLocalDescription(answer).catch(console.log)];
                    case 3:
                        _a.sent();
                        local = this.rtc.localDescription;
                        if (this.isConnected) {
    ...
    WebRTC.prototype.dataChannelEvents = function (channel) {
        ...
        channel.onopen = function () {
            if (!_this.isConnected) {
                console.log("connected", _this.nodeId);
