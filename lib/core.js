...
var injectableNavigator = typeof window !== "undefined" ? window.navigator : undefined;
            ...
            return tslib_1.__generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        ...
                        if (!!Object.keys(this.dataChannels).includes(label)) return [3 /*break*/, 6];
                        _a.label = 1;
                    case 1:
                        _a.trys.push([1, 5, , 6]);
                        if (!injectableNavigator.platform) return [3 /*break*/, 3];
            ...
            return tslib_1.__generator(this, function (_b) {
                switch (_b.label) {
                    case 0:
                        ...
                        rtc.close();
                        this.rtc = null;
                        return [4 /*yield*/, new Promise(function (r) { return setTimeout(r, 1000 * 30); })];
                    case 1:
                        _b.sent();
                        return [2 /*return*/];
                }
