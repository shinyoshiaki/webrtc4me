...
var WebRTC = /** @class */ (function () {
    ...
    WebRTC.prototype.prepareNewConnection = function () {
        ...
        peer.onicecandidate = function (evt) {
            if (!_this.isConnected) {
                if (evt.candidate) {
                    if (trickle) {
                        _this.onSignal.execute({ type: "candidate", ice: evt.candidate });
                    }
                }
                else {
    ...
    WebRTC.prototype.createDatachannel = function (label) {
        return tslib_1.__awaiter(this, void 0, void 0, function () {
            ...
            return tslib_1.__generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        if (!!Object.keys(this.dataChannels).includes(label)) return [3 /*break*/, 4];
                        _a.label = 1;
                    case 1:
                        _a.trys.push([1, 3, , 4]);
    ...
    WebRTC.prototype.send = function (data, label) {
        return tslib_1.__awaiter(this, void 0, void 0, function () {
            var arrayBufferService, error_1;
            return tslib_1.__generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        arrayBufferService = this.services.arrayBufferService;
                        label = label || "datachannel";
                        if (!!Object.keys(this.dataChannels).includes(label)) return [3 /*break*/, 2];
                        return [4 /*yield*/, this.createDatachannel(label)];
                    case 1:
                        _a.sent();
                        _a.label = 2;
                    case 2:
                        _a.trys.push([2, 8, , 9]);
                        if (!(typeof data === "string")) return [3 /*break*/, 3];
                        this.dataChannels[label].send(data);
                        return [3 /*break*/, 7];
                    case 3:
                        if (!(data.byteLength > 16000)) return [3 /*break*/, 6];
                        return [4 /*yield*/, this.createDatachannel(arrayBufferService.label)];
                    case 4:
                        _a.sent();
                        return [4 /*yield*/, arrayBufferService.send(data, label, this.dataChannels[arrayBufferService.label])];
                    case 5:
                        _a.sent();
                        return [3 /*break*/, 7];
                    case 6:
