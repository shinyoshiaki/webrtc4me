...
var _a = window, RTCPeerConnection = _a.RTCPeerConnection, RTCSessionDescription = _a.RTCSessionDescription, RTCIceCandidate = _a.RTCIceCandidate;
            ...
            return tslib_1.__generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        ...
                        return [4 /*yield*/, this.rtc.setRemoteDescription(offer).catch(function () { return "err"; })];
                    case 1:
                        err = _a.sent();
                        if (err)
                            return [2 /*return*/];
