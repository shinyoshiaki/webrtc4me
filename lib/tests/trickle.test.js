...
var peerOffer = new index_1.default({ nodeId: "offer", trickle: true, wrtc: wrtc });
var peerAnswer = new index_1.default({ nodeId: "answer", trickle: true, wrtc: wrtc });
test("trickle", function () { return tslib_1.__awaiter(void 0, void 0, void 0, function () {
    var test;
